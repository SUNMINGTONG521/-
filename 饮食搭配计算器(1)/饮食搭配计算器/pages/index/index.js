Page({
  ...
  onShow: function () {   //页面显示时出现2秒的加载过程
    ...
    this.setData({
      hasList:true,
      carts: [
        { id: 1, title: "红豆", selected: false, num: 100,price:329, zhifang: 0.6,danbai:20.2},
        { id: 2, title: "绿豆", selected: false, num: 100,price:329, zhifang: 0.8,danbai:21.6 }, 
        { id: 3, title: "扁豆", selected: false, num: 100,price:257,zhifang: 0.4,danbai:25.3},
        {id: 4, title: "豌豆", selected: false, num: 100,price:313, zhifang: 1.1 ,danbai:20.3},
        {id: 5, title: "大豆", selected: false, num: 100,price:359, zhifang: 16.0 ,danbai:35.0},
        {id: 6, title: "黑豆", selected: false, num: 100,price:381, zhifang: 15.9 ,danbai:36.0},
      ]
    })
    //显示页面时就调用总价格和总数量
    this.getTotalPrice();
