Page({
  ...
  onShow: function () {   //页面显示时出现2秒的加载过程
    ...
    this.setData({
      hasList:true,
      carts: [
        { id: 1, title: "白菜", selected: false, num: 100,price:17, zhifang: 0.1 ,danbai:1.5},
        { id: 2, title: "芹菜", selected: false, num: 100, price:13,zhifang:0.2 ,danbai:1.2 }, 
        { id: 3, title: "黄瓜", selected: false, num: 100,price:15,zhifang: 0.2,danbai:0.6 },
        { id: 4, title: "青椒", selected: false, num: 100,price:23, zhifang:0.3 ,danbai:1.8 },
        { id: 5, title: "油菜", selected: false, num: 100,price:18, zhifang:0.5,danbai:1.8 },
        { id: 6, title: "西红柿", selected: false, num: 100, price:19,zhifang:0.4 ,danbai: 1.2},
        { id: 7, title: "菠菜", selected: false, num: 100, price:24,zhifang:0.3 ,danbai:2.6 },
      ]
    })
    //显示页面时就调用总价格和总数量
    this.getTotalPrice();
